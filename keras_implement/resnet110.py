...
WIDTH = 32
HEIGHT = 32
BATCH_SIZE = 64       #decrease the number if you run out your GPU memory
EPOCHES = 500
ITERATIONS = 50000//BATCH_SIZE +1
WEIGHT_DECAY = 1e-4           #according to the paper
FILE_PATH = "/cluster/home/it_stu27/dllab/model/best_model.h5"
TENSORBOARD_PATH = '/cluster/home/it_stu27/dllab/log/'
...
if __name__ == '__main__':
    ...
    cbks = [LearningRateScheduler(schedule=scheduler),checkpoint,TensorBoard(log_dir=TENSORBOARD_PATH)]
    ...
    resnet.fit_generator(generator=training_generator,
                         steps_per_epoch=ITERATIONS,shuffle=1,
                         epochs=EPOCHES,
                         callbacks=cbks,
                         validation_data=(x_test,y_test))
    
    resnet.save("resnet110.h5")
