...
parser.add_argument("--clr_mode", default='triangular')
parser.add_argument("--clr_gamma", default=1.0, type=float)
...
parser.add_argument("--label_smooth_eps", type=float, default=1e-3)
parser.add_argument("--mixup_alpha", type=float, default=-1)

# mobile resnet parameters
parser.add_argument("--expand_ratio", type=int, default=3)
# debug
...
if args.add_stamp and not args.debug:
...
if args.debug:
    ...
    print("WARNIBG:")
    print("\tDebug mode will delete the original debug directory('./summary/model_debug')")
